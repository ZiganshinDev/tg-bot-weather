...
func (c *weatherServiceClient) GetWeather(ctx context.Context, in *WeatherRequest, opts ...grpc.CallOption) (*WeatherReply, error) {
	out := new(WeatherReply)
	err := c.cc.Invoke(ctx, "/weatherservice.WeatherService/GetWeather", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedWeatherServiceServer) GetWeather(context.Context, *WeatherRequest) (*WeatherReply, error) {
...
func _WeatherService_GetWeather_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/weatherservice.WeatherService/GetWeather",
	}
...
var WeatherService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "adapter/weatherclient/weatherservice.proto",
}
